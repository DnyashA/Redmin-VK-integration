...
Rails.application.routes.draw do
  ...
  get 'my_controller/bind_social', :controller => 'my', :action => 'bind_social'
  post 'my_controller/bind_social', :controller => 'my', :action => 'bind_social'
  post 'my_controller/message_send', :controller => 'my', :action => 'message_send'
  get 'my_controller/message_send', :controller => 'my', :action => 'message_send'
